...
- [Manifests](manifests/README.md)
  - [actions](manifests/actions/README.md)
    ...
    - [file.copy](manifests/actions/file-copy.md)
    - [package.install](manifests/actions/package-install.md)
  - [depends](manifests/depends/README.md)
- [Manifest provider](provider/README.md)
